                ...
                <form method="post" action="/{{ request()->segment(1) }}/outlet/{{ $o->id }}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-sm-9" id="nama" value="{{ $o->nama }}"
                                name="nama">
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control col-sm-9" id="alamat" value="{{ $o->alamat }}"
                                name="alamat">
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="tlp"></label>
                            <input type="text" class="form-control col-sm-9" id="tlp" value="{{ $o->tlp }}"
                                name="tlp">
                        </div>
                    </div>
            </div>
