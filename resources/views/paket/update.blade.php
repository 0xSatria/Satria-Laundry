      ...
      <form method="POST" action="{{ url('paket/'.$p->id) }}">
        ...
        <div class="card-body">
            <div class="form-group">
              ...
              <select name="jenis" class="form-control col-sm-9" id="jenis" placeholder="Jenis" name="jenis"><option value="kiloan">Kiloan</option>
          ...
          <div class="card-body">
            <div class="form-group">
              <label for="nama"></label>
              <input type="text" class="form-control col-sm-9" id="nama_paket" placeholder="Nama Paket" name="nama_paket" value="{{ $p->nama_paket }}">
            </div>
          </div>
